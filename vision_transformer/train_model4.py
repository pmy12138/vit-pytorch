...
def main(args):
    ...
    # 创建实验目录
    exp_name = f"model4.2_patch{args.patch_size}_dim{args.embed_dim}_depth{args.depth}_heads{args.num_heads}"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--depth', type=int, default=6)  # 从8改成6
